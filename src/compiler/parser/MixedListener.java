...
public interface MixedListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MixedParser#store}.
	 * @param ctx the parse tree
	 */
	void enterStore(MixedParser.StoreContext ctx);
	/**
	 * Exit a parse tree produced by {@link MixedParser#store}.
	 * @param ctx the parse tree
	 */
	void exitStore(MixedParser.StoreContext ctx);
	/**
